...
open class DiffableCellGenerator<Cell: ConfigurableItem>: BaseCellGenerator<Cell>,
                                                                            IdOwner,
...
extension StaticDataDisplayWrapper where Base: ConfigurableItem, Base.Model: Equatable {
...
extension StaticDataDisplayWrapper where Base: ConfigurableItem, Base.Model: Equatable & IdOwner {
