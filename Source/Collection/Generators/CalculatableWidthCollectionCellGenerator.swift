...
public class CalculatableWidthCollectionCellGenerator<Cell: ConfigurableItem & CalculatableWidthItem>: BaseCellGenerator<Cell> & SizableItem where Cell: UICollectionViewCell {
